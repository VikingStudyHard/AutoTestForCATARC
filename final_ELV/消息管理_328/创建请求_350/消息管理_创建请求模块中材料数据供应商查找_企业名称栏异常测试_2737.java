 ...
 * 所属模块: 创建请求(#350)
 * 用例名称: 消息管理-创建请求模块中材料数据供应商查找-企业名称栏异常测试
...
public class 消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737 extends Selenium_Test_Base {
	
	public 消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737(){
		super();
	}
	
	public 消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737(WebDriver driver){
		super(driver);
	}
	...
	public void searchCompanyTest(){
		...
		getElement(ElementEnum_创建请求_350.搜索企业窗口企业名称输入框).sendKeys(" ");
		WebDriverConfiguration.operationInterval();
		...
		testQueryByCity("Kang");
		testQueryByCity("kang");
		testQueryByCity("Ｋａｎｇ");
		testQueryByCity("香港");
