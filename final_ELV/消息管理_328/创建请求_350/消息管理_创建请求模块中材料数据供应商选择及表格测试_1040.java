 ...
 * 所属模块: 创建请求(#350)
 * 用例名称: 消息管理-创建请求模块中材料数据供应商选择及表格测试
 ...
 * 测试预期->8. 该企业的一整行颜色变深
 * 测试步骤->9. 点击确定按钮
 * 测试预期->9. 企业选择窗口关闭， 回到创建请求界面， 材料数据供应商一栏中显示为步骤8中所选企业
 * 
 */

public class 消息管理_创建请求模块中材料数据供应商选择及表格测试_1040 extends Selenium_Test_Base {
	
	public 消息管理_创建请求模块中材料数据供应商选择及表格测试_1040(){
		super();
	}
	
	public 消息管理_创建请求模块中材料数据供应商选择及表格测试_1040(WebDriver driver){
		super(driver);
	}
	...
	public String getDescription(){
		return "测试用例id: 1040\n"
				...
				+" 所属模块: 创建请求(#350)\n"
				+" 用例名称: 消息管理-创建请求模块中材料数据供应商选择及表格测试\n"
				+" 前置条件: 登录ELV环境合规系统，左侧树形结构选择 消息管理-创建请求 点击第三行 材料数据供应商 后的查找按钮 \n"
				+" 测试步骤->1. 在国家下拉栏中选择中国.，点击查找按钮\n"
				+" 测试预期->1. 下方分页显示国家为中国的企业列表， 表格右上方有确定、取消两个按钮， 表格中各项可以选择， 下方有翻页按钮，且翻至首页和向前翻页按钮为灰色不可点击， 下方左侧显示“第1页，共1138页”， 下方右侧显示“显示1-25条，共28440条”\n"
				+" 测试步骤->2. 点击向下翻页按钮\n"
				+" 测试预期->2. 表格跳转至第二页， 下方翻页按钮的向前翻页和翻至首页按钮变为蓝色可以点击，下方信息变为： 左侧“第2页，共1138页”， 右侧“显示26-50条，共28440条”\n"
