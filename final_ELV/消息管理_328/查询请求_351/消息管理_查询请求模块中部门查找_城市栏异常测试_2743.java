...
import cn.edu.tju.scs.seql.final_ELV.消息管理_328.创建请求_350.消息管理_创建请求模块中材料数据供应商查找_城市栏异常测试_2740;
...
public class 消息管理_查询请求模块中部门查找_城市栏异常测试_2743 extends Selenium_Test_Base {
	
	public 消息管理_查询请求模块中部门查找_城市栏异常测试_2743(){
		super();
	}
	
	public 消息管理_查询请求模块中部门查找_城市栏异常测试_2743(WebDriver driver){
		super(driver);
	}
	...
	public void searchCompanyTest(){
		消息管理_创建请求模块中材料数据供应商查找_城市栏异常测试_2740 x = new 消息管理_创建请求模块中材料数据供应商查找_城市栏异常测试_2740(driver);
		x.searchCompanyTest();
	}
