...
import cn.edu.tju.scs.seql.final_ELV.消息管理_328.创建请求_350.消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737;
 ...
 * 所属模块: 查询请求(#351)
 * 用例名称: 消息管理-查询请求模块中部门查找-企业名称栏异常测试
 * 前置条件: 登录ELV环境合规系统，左侧树形结构选择 消息管理-查询请求
 *         点击部门栏后的查找按钮
 * 测试步骤->1. 企业名称中搜索“Kang”，点击查找按钮
 * 测试预期->1. 显示企业名称为“Kang”的企业信息
 * 测试步骤->2. 企业名称中搜索“kang”，点击查找按钮
 * 测试预期->2. 无企业信息显示
 * 测试步骤->3. 企业名称中搜索“Ｋａｎｇ”，点击查找按钮
 * 测试预期->3. 无企业信息显示
 * 测试步骤->4. 企业名称中搜索空格“ ”，点击查找按钮
 * 测试预期->4. 显示所有企业信息
 * 测试步骤->5. 企业名称中搜索“香港”，点击查找按钮
 * 测试预期->5. 显示所有企业名称中带有“香港”的企业信息列表
 * 测试步骤->6. 企业名称中搜索“<script>alert("test");</script>”， 点击查找按钮
 * 测试预期->6. 无企业信息显示， 无异常提示
 * 测试步骤->7. 企业名称中搜索“&lt;script&gt;alert("test");&lt;/script&gt;”， 点击查找按钮
 * 测试预期->7. 无企业信息显示， 无异常提示
 * 
 */

public class 消息管理_查询请求模块中部门查找_企业名称栏异常测试_2746 extends Selenium_Test_Base {
	
	public 消息管理_查询请求模块中部门查找_企业名称栏异常测试_2746(){
		super();
	}
	
	public 消息管理_查询请求模块中部门查找_企业名称栏异常测试_2746(WebDriver driver){
		super(driver);
	}
	...
	public void searchCompanyTest(){
		消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737 x = new 消息管理_创建请求模块中材料数据供应商查找_企业名称栏异常测试_2737(driver);
		x.searchCompanyTest();
	}
