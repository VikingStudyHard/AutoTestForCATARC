 ...
 * 所属模块: 查询请求(#351)
 * 用例名称: 消息管理-查询请求模块中添加CAMDS账号按钮-删除按钮
 * 前置条件: 
...
public class 消息管理_查询请求模块中添加CAMDS账号按钮_删除按钮_6484 extends Selenium_Test_Base {
	
	public 消息管理_查询请求模块中添加CAMDS账号按钮_删除按钮_6484(){
		super();
	}
	
	public 消息管理_查询请求模块中添加CAMDS账号按钮_删除按钮_6484(WebDriver driver){
		super(driver);
	}
