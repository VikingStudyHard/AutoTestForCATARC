 ...
 * 所属模块: 部门信息(#357)
 * 用例名称: 验证部门信息是否正常显示
 * 前置条件: 能正确进入ELV环境合规系统（标准版）页面
 * 测试步骤->1. 点击左侧竖置功能栏中系统管理下的部门信息
 * 测试预期->1. 页面右侧显示部门详细情况，其余地方正常显示。
 * 
 */

public class 验证部门信息是否正常显示_995 extends Selenium_Test_Base {
	
	public 验证部门信息是否正常显示_995(){
		super();
	}
	
	public 验证部门信息是否正常显示_995(WebDriver driver){
		super(driver);
	}
