 ...
 * 所属模块: 禁限用物质豁免分析(#347)
 * 用例名称: 验证禁限用物质豁免分析 导出有害物质清单内容是否正确（3）
 ...
 * 测试步骤->3. 点击查看清单内容
 * 测试预期->3. 有害物质信息表中“零部件及材料名称”在现有规则（总成零部件名称-直接父零部件名称-材料名称）上加上“豁免范围”说明，格式：“总成零部件名称-直接父零部件名称-材料名称（豁免范围）”
 * 
 */

public class 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_3__13627 extends Selenium_Test_Base {
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_3__13627(){
		super();
	}
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_3__13627(WebDriver driver){
		super(driver);
	}
