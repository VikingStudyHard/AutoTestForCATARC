 ...
 * 所属模块: 禁限用物质豁免分析(#347)
 * 用例名称: 验证禁限用物质豁免分析 导出有害物质清单内容是否正确
 ...
 * 测试步骤->3. 点击查看清单内容
 * 测试预期->3. 当有害物质含量为范围时，取最大值为百分含量值
 * 
 */

public class 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_13593 extends Selenium_Test_Base {
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_13593(){
		super();
	}
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_13593(WebDriver driver){
		super(driver);
	}
