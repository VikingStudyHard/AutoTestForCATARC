 ...
 * 所属模块: 禁限用物质豁免分析(#347)
 * 用例名称: 验证禁限用物质豁免分析 导出有害物质清单内容是否正确（4）
 ...
 * 测试步骤->3. 点击查看清单内容
 * 测试预期->3. 人工指定的零部件或材料：显示指定项目名称，如：“蓄电池”，“减震器”，“电路板及其它电气部件用焊料”等
 * 
 */

public class 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_4__13628 extends Selenium_Test_Base {
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_4__13628(){
		super();
	}
	
	public 验证禁限用物质豁免分析_导出有害物质清单内容是否正确_4__13628(WebDriver driver){
		super(driver);
	}
