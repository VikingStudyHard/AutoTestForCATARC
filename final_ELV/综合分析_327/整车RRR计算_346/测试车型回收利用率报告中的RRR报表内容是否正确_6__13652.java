 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 测试车型回收利用率报告中的RRR报表内容是否正确（6）
 ...
 * 测试预期->5. 该附表3中的“材料分类”对应已标记mTr的“CAMDS【材料分类】（材料名称）”，其材料名称指在mTr的标记时，在下拉列表框中选择的材料名称
 * 
 */

public class 测试车型回收利用率报告中的RRR报表内容是否正确_6__13652 extends Selenium_Test_Base {
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_6__13652(){
		super();
	}
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_6__13652(WebDriver driver){
		super(driver);
	}
