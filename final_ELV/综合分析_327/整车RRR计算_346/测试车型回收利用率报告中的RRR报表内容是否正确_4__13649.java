 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 测试车型回收利用率报告中的RRR报表内容是否正确（4）
 ...
 * 测试预期->5. 除预处理阶段、拆解阶段的零部件之外的整车所有金属材料，其中材料分类对应CAMDS系统中的【材料分类】，包括1-4类金属材料，且导出【材料分类】的名称，而非代号
 * 
 */

public class 测试车型回收利用率报告中的RRR报表内容是否正确_4__13649 extends Selenium_Test_Base {
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_4__13649(){
		super();
	}
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_4__13649(WebDriver driver){
		super(driver);
	}
