 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 测试车型回收利用率报告中的RRR报表内容是否正确（11）
 ...
 * 测试预期->5. 显示零部件单个计算质量，半成品质量，材料质量，半成品下挂接材料、材料下挂接材料时，子材料质量需换算。最终结果保留1位小数
 * 
 */

public class 测试车型回收利用率报告中的RRR报表内容是否正确_11__13658 extends Selenium_Test_Base {
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_11__13658(){
		super();
	}
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_11__13658(WebDriver driver){
		super(driver);
	}
