 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 验证整车RRR计算中确定功能是否可实现-基本信息操作-自动标注
 * 前置条件: 能正常进入综合分析模块
...
public class 验证整车RRR计算中确定功能是否可实现_基本信息操作_自动标注_4201 extends Selenium_Test_Base {
	
	public 验证整车RRR计算中确定功能是否可实现_基本信息操作_自动标注_4201(){
		super();
	}
	
	public 验证整车RRR计算中确定功能是否可实现_基本信息操作_自动标注_4201(WebDriver driver){
		super(driver);
	}
