 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 测试车型回收利用率报告中的RRR报表内容是否正确（10）
 ...
 * 测试预期->5. 节点类型为零部件、半成品时，全部”/”填充。节点类型为材料时，显示人工指定内容。若人工指定为“其它”或未指定，【回收利用属性】显示“-”。若指定为mTr，【技术说明】显示人工选择的技术编号，其它情况【技术说明】显示“-”
 * 
 */

public class 测试车型回收利用率报告中的RRR报表内容是否正确_10__13657 extends Selenium_Test_Base {
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_10__13657(){
		super();
	}
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_10__13657(WebDriver driver){
		super(driver);
	}
