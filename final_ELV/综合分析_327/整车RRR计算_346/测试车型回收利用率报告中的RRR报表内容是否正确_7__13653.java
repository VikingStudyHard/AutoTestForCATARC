 ...
 * 所属模块: 整车RRR计算(#346)
 * 用例名称: 测试车型回收利用率报告中的RRR报表内容是否正确（7）
 ...
 * 测试预期->5. 该附表3中的“已获验证技术名称/编号(CPTL)”对应材料标记的“已获得验证的可再利用技术编号”中的任何一个技术编号
 * 
 */

public class 测试车型回收利用率报告中的RRR报表内容是否正确_7__13653 extends Selenium_Test_Base {
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_7__13653(){
		super();
	}
	
	public 测试车型回收利用率报告中的RRR报表内容是否正确_7__13653(WebDriver driver){
		super(driver);
	}
