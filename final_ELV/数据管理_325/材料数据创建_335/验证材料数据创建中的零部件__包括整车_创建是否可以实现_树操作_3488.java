 ...
 * 所属模块: 材料数据创建(#335)
 * 用例名称: 验证材料数据创建中的零部件 （包括整车）创建是否可以实现-树操作
 * 前置条件: 拥有MDS材料数据创建的权限
...
public class 验证材料数据创建中的零部件__包括整车_创建是否可以实现_树操作_3488 extends Selenium_Test_Base {
	
	public 验证材料数据创建中的零部件__包括整车_创建是否可以实现_树操作_3488(){
		super();
	}
	
	public 验证材料数据创建中的零部件__包括整车_创建是否可以实现_树操作_3488(WebDriver driver){
		super(driver);
	}
