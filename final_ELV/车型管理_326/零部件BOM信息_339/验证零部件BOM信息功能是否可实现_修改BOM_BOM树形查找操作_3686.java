 ...
 * 所属模块: 零部件BOM信息(#339)
 * 用例名称: 验证零部件BOM信息功能是否可实现-修改BOM-BOM树形查找操作
 * 前置条件: 能正常进入车型管理模块
...
public class 验证零部件BOM信息功能是否可实现_修改BOM_BOM树形查找操作_3686 extends Selenium_Test_Base {
	
	public 验证零部件BOM信息功能是否可实现_修改BOM_BOM树形查找操作_3686(){
		super();
	}
	
	public 验证零部件BOM信息功能是否可实现_修改BOM_BOM树形查找操作_3686(WebDriver driver){
		super(driver);
	}
