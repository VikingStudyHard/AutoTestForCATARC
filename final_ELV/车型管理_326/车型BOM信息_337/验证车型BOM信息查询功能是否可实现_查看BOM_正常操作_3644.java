 ...
 * 所属模块: 车型BOM信息(#337)
 * 用例名称: 验证车型BOM信息查询功能是否可实现-查看BOM-正常操作
 * 前置条件: 能正常进入车型管理模块
 * 测试步骤->1. 点击查看BOM按钮
...
public class 验证车型BOM信息查询功能是否可实现_查看BOM_正常操作_3644 extends Selenium_Test_Base {
	
	public 验证车型BOM信息查询功能是否可实现_查看BOM_正常操作_3644(){
		super();
	}
	
	public 验证车型BOM信息查询功能是否可实现_查看BOM_正常操作_3644(WebDriver driver){
		super(driver);
	}
	...
	public void detailedOperation(){
		...
		getElement(ElementEnum_车型BOM信息_337.提示框确定按钮).click();
