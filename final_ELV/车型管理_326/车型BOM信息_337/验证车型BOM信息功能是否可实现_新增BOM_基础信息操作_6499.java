...
public class 验证车型BOM信息功能是否可实现_新增BOM_基础信息操作_6499 extends Selenium_Test_Base {
	
	public 验证车型BOM信息功能是否可实现_新增BOM_基础信息操作_6499(){
		super();
	}
	
	public 验证车型BOM信息功能是否可实现_新增BOM_基础信息操作_6499(WebDriver driver){
		super(driver);
	}
