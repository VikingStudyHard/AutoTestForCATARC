...
public class 验证车型BOM信息功能是否可实现_新增BOM_BOM树形新增操作_3649 extends Selenium_Test_Base {
	
	public 验证车型BOM信息功能是否可实现_新增BOM_BOM树形新增操作_3649(){
		super();
	}
	
	public 验证车型BOM信息功能是否可实现_新增BOM_BOM树形新增操作_3649(WebDriver driver){
		super(driver);
	}
