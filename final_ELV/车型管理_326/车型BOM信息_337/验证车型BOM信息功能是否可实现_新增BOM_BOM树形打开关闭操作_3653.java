 ...
 * 所属模块: 车型BOM信息(#337)
 * 用例名称: 验证车型BOM信息功能是否可实现-新增BOM-BOM树形打开关闭操作
 * 前置条件: 能正常进入车型管理模块
...
public class 验证车型BOM信息功能是否可实现_新增BOM_BOM树形打开关闭操作_3653 extends Selenium_Test_Base {
	
	public 验证车型BOM信息功能是否可实现_新增BOM_BOM树形打开关闭操作_3653(){
		super();
	}
	
	public 验证车型BOM信息功能是否可实现_新增BOM_BOM树形打开关闭操作_3653(WebDriver driver){
		super(driver);
	}
	...
	public void detailedOperation(){
		...
		getElement(ElementEnum_车型BOM信息_337.车型商标输入框).sendKeys("杨杨");
