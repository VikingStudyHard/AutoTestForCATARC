...
public class 验证行业动态编辑功能是否可实现_编辑文本2_4471 extends Selenium_Test_Base {
	
	public 验证行业动态编辑功能是否可实现_编辑文本2_4471(){
		super();
	}
	
	public 验证行业动态编辑功能是否可实现_编辑文本2_4471(WebDriver driver){
		super(driver);
	}
