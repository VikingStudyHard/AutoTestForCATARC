 ...
 * 所属模块: 标准信息(#352)
 * 用例名称: 验证标准信息新增功能是否可实现-基本物质信息-添加查询
 * 前置条件: 能正常进入法规信息模块
 * 测试步骤->1. 点击页面中的新增按钮
...
public class 验证标准信息新增功能是否可实现_基本物质信息_添加查询_4534 extends Selenium_Test_Base {
	
	public 验证标准信息新增功能是否可实现_基本物质信息_添加查询_4534(){
		super();
	}
	
	public 验证标准信息新增功能是否可实现_基本物质信息_添加查询_4534(WebDriver driver){
		super(driver);
	}
	...
	public void detailedOperation(){
		...
		getElement(ElementEnum_标准信息_352.添加物质窗口物质分类下拉选项_全部).click();
		getElement(ElementEnum_标准信息_352.添加物质窗口中文名称输入框).clear();
		getElement(ElementEnum_标准信息_352.添加物质窗口英文名称输入框).clear();
		getElement(ElementEnum_标准信息_352.添加物质窗口英文名称输入框).sendKeys("2-phen");
		getElement(ElementEnum_标准信息_352.添加物质窗口查询按钮).click();
		WebDriverConfiguration.operationInterval();
		a.judgeMaskLoadFirst();
		...
		getElement(ElementEnum_标准信息_352.添加物质窗口中文名称输入框).clear();
		getElement(ElementEnum_标准信息_352.添加物质窗口英文名称输入框).clear();
		getElement(ElementEnum_标准信息_352.添加物质窗口英文名称输入框).sendKeys("2-phenylimidazole");
		getElement(ElementEnum_标准信息_352.添加物质窗口查询按钮).click();
		WebDriverConfiguration.operationInterval();
		a.judgeMaskLoadFirst();
