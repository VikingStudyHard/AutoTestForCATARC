 ...
 */
public enum ElementEnum_最新法规_354  implements ElementEnum {
	FanXiangyu(ByEnum.ById,"id"),
	一级目录名称(ByEnum.ById,"tool-1039-toolEl"),
	二级目录名称(ByEnum.ByXPath,".//*[@id='treeview-1029']/table/tbody/tr[4]/td/div/a"),
	leftFrame(ByEnum.ByName,"leftFrame"),
	rightFrame(ByEnum.ByName,"mainFrame"),
	标题输入框(ByEnum.ByXPath,".//*[@id='newLawInfoTitleTextField-inputEl']"),
	开始时间输入框(ByEnum.ByXPath,".//*[@id='newLawInfoStartTimeTextField-inputEl']"),
	结束时间输入框(ByEnum.ByXPath,".//*[@id='newLawInfoEndTimeTextField-inputEl']"),
	检索按钮(ByEnum.ByXPath,".//*[@id='newLawInfoEndTimeTextField']/../following::td[1]/div"),
	...
	private String name;
	private ElementEnum_最新法规_354(ByEnum by, String name){
		this.byWhat = by;
		this.name = name;
	}
