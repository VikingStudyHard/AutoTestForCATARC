...
public class 验证最新法规编辑功能是否可实现_编辑文本_4480 extends Selenium_Test_Base {
	
	public 验证最新法规编辑功能是否可实现_编辑文本_4480(){
		super();
	}
	
	public 验证最新法规编辑功能是否可实现_编辑文本_4480(WebDriver driver){
		super(driver);
	}
